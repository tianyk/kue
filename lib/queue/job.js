...
Job.prototype.state = function(state, fn) {
    ...
    multi
        ...
        .zadd(client.getKey('jobs:' + state), this._priority, this.id) // q:job:state 优先级 jobID
    ...
    ('inactive' === state) ? multi.lpush(client.getKey(this.type + ':jobs'), 1): noop(); // lpush q:`type`:jobs
